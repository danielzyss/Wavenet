...
th_shape_L2 = [1, 1, int((Level_Of_Decomposition_First_Layer*TS_length)/maxpool_size_L1**2)]
th_value_L2 = tf.Variable(tf.truncated_normal(shape=th_shape_L2, mean=0.0, stddev=0.5))

full_shape_L3 = [int((Level_Of_Decomposition_Second_Layer/maxpool_size_L2) *
                 (Level_Of_Decomposition_First_Layer * TS_length)/(maxpool_size_L1**2 * maxpool_size_L2)),
                 Size_Third_Layer]
